<template>
  <!--
    Corps des conditions générales de vente, sans gabarit ni titre de page.

    Source unique : la page `/cgv` l'enchâsse dans le gabarit légal, la modale
    du récapitulatif de commande l'affiche telle quelle. Deux copies du texte
